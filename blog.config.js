r'y// 注: process.env.XX是Vercel的环境变量，配置方式见：https://docs.tangly1024.com/zh/features/personality
const BLOG = {
  AUTHOR: 'medryan', // 作者
  BIO: '小y的学习资料', // 作者简介
  email: 'medryan001@outlook.com',
  LINK: 'http://medryan.vercel.app', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '65ac03cdbbfa44c0ae7865a87126cd00', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'medryan001@outlook.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Medryan's BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
